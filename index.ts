...
app.use(cors({ credentials: true, origin: ['https://radiant.cool', 'https://mail.hyper.pics', 'http://localhost:3000', 'http://localhost:3001', 'http://localhost:3002'], methods: ['GET', 'POST', 'DELETE', 'UPDATE', 'PUT', 'PATCH'] }))
app.options('*', cors({ credentials: true, origin: ['https://radiant.cool', 'https://mail.hyper.pics', 'http://localhost:3000', 'http://localhost:3001', 'http://localhost:3002'] }));
